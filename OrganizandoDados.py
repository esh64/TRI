...
for areaM in questoesAreas.keys():
    ...
    microdados = pd.read_csv( MICRODADOS_2017_URL, encoding = "ISO-8859-1",sep =';',usecols=['NU_INSCRICAO','TP_PRESENCA_'+area,'CO_PROVA_'+area,'NU_NOTA_'+area,'TX_RESPOSTAS_'+area,'TX_GABARITO_'+area, 'TP_LINGUA'],nrows=numero_linhas).dropna()
